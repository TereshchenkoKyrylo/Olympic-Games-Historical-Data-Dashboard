 SELECT
        ...
        RIGHT(Games,CHARINDEX(' ', Games) + 1 ) AS 'Season', -- Split column to isolate Season, based on space
        [Sport],
        [Event],
  ...
  WHERE RIGHT(Games,CHARINDEX(' ', Games) + 1 ) = 'Summer' -- Where Clause to isolate Summer Season